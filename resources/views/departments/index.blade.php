...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row btn-aligned-bottom">
            ...
            <div class="col-sm-6 m-t">
                <a href="{{ route('departments.create') }}" class="btn btn-primary m-r pull-right margin-bottom">{{ Lang::get('departments.create_new') }}</a>
            </div>
        </div>
        <div class="col-sm-12">
            <hr>
                                    ...
                                    @if ($user->hasAccessTo('partner', 'delete', 0))
                                        {!! Form::open(
                                            [
                                                ...
                                                'style' => 'max-width: 32px; margin:0; display: inline-block; float: none;',
                                                'method' => 'DELETE'
                                            ])
                                        !!}
