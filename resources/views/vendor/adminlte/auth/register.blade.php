    ...
    <div id="app">
        <div class="register-box">
            <div class="register-logo">
                <a href="{{ url('/home') }}"><b>Компания</b>ГРОССБУХ</a>
            </div>

            @if (count($errors) > 0)
                <div class="alert alert-danger">
                    <strong>Упс!</strong> {{ trans('adminlte_lang::message.someproblems') }}<br><br>
                    <ul>
                        ...
                        {{--<div class="row">--}}
                            ...
                            {{--<div class="col-xs-8">--}}
                                {{--<div class="form-group">--}}
                                    ...
                                    {{--<a href="#" data-toggle="modal" data-target="#termsModal">{{ trans('adminlte_lang::message.terms') }}</a>--}}
                                {{--</div>--}}
                            {{--</div><!-- /.col -->--}}
                        {{--</div>--}}
                    {{--</div>--}}
